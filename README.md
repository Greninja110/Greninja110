...
A Desktop Application, Media player can be used to listen music, download music etc. I have Plenty of Things i want to add to this Like a MP4 support , and music equalizer. But my Main Aim is to make it User Friendly, Easy to use. VLC is very powerful and is very good , but the GUI(The user Interface) is not that Great. I aim to Make a easy to use GUI , I can not make as powerful and as good as VLC is but it should be able handle the Frequently used format like .mp3 , .mkv .   

### BlockChainCV([link to repo](https://github.com/Greninja110/BlockChainCV))
![](https://img.shields.io/badge/Category-Blockchain-informational?style=flat&color=2bbc8a)

### Sales Force Analyze Dashboard([link to repo](https://github.com/Greninja110/sales_force_1))
![](https://img.shields.io/badge/Category-AIML-informational?style=flat&color=2bbc8a)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=flat&logo=linkedin)]((https://www.linkedin.com/in/abhijeet-sahoo-46151a354/))
[![Twitter](https://img.shields.io/badge/Twitter-Follow-blue?style=flat&logo=twitter)]((https://x.com/Abhi__253__162))
...
<!-- Footer -->
---
From Abhijeet Sahoo(https://github.com/Greninja110)
